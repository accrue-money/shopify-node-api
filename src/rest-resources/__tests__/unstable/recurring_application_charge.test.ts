...
import {RecurringApplicationCharge} from '../../unstable';
...
describe('RecurringApplicationCharge resource', () => {
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/unstable/recurring_application_charges/455696195.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_9', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/unstable/recurring_application_charges/455696195/customize.json',
