...
import {FulfillmentOrder} from '../../unstable';
...
describe('FulfillmentOrder resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/unstable/orders/450789469/fulfillment_orders.json',
      query: '',
      headers,
      data: null
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/unstable/fulfillment_orders/1046000847.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/unstable/fulfillment_orders/1046000848/cancel.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/unstable/fulfillment_orders/1046000851/close.json',
      query: '',
      headers,
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/unstable/fulfillment_orders/1046000852/move.json',
      query: '',
      headers,
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/unstable/fulfillment_orders/1046000854/open.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/unstable/fulfillment_orders/1046000855/reschedule.json',
      query: '',
      headers,
  ...
  it('test_8', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/unstable/fulfillment_orders/1046000856/hold.json',
      query: '',
      headers,
  ...
  it('test_9', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/unstable/fulfillment_orders/1046000858/release_hold.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
