...
import {CustomerSavedSearch} from '../../unstable';
...
describe('CustomerSavedSearch resource', () => {
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/unstable/customer_saved_searches/789629109.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_10', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/unstable/customer_saved_searches/789629109/customers.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
