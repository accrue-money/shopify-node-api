...
import {CollectionListing} from '../../unstable';
...
describe('CollectionListing resource', () => {
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/unstable/collection_listings/841564295/product_ids.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/unstable/collection_listings/482865238.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
