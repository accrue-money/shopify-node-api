...
import {GiftCardAdjustment} from '../../unstable';
...
describe('GiftCardAdjustment resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/unstable/gift_cards/1035197676/adjustments.json',
      query: '',
      headers,
      data: null
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/unstable/gift_cards/1035197676/adjustments/9.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
