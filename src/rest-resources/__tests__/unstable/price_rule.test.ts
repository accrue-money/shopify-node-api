...
import {PriceRule} from '../../unstable';
...
describe('PriceRule resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/unstable/price_rules.json',
      query: '',
      headers,
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/unstable/price_rules/507328175.json',
      query: '',
      headers,
  ...
  it('test_10', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/unstable/price_rules/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
