...
import {SmartCollection} from '../../unstable';
...
describe('SmartCollection resource', () => {
  ...
  it('test_12', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/unstable/smart_collections/482865238.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_20', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/unstable/smart_collections/482865238/order.json',
