...
import {FulfillmentRequest} from '../../unstable';
...
describe('FulfillmentRequest resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/unstable/fulfillment_orders/1046000840/fulfillment_request.json',
      query: '',
      headers,
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/unstable/fulfillment_orders/1046000843/fulfillment_request.json',
      query: '',
      headers,
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/unstable/fulfillment_orders/1046000844/fulfillment_request/accept.json',
      query: '',
      headers,
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/unstable/fulfillment_orders/1046000845/fulfillment_request/reject.json',
      query: '',
      headers,
