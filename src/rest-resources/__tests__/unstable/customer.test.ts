...
describe('Customer resource', () => {
  ...
  it('test_10', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/unstable/customers/207119551.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_15', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/unstable/customers/207119551/account_activation_url.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_16', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/unstable/customers/207119551/send_invite.json',
      query: '',
      headers,
  ...
  it('test_19', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/unstable/customers/207119551/orders.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
